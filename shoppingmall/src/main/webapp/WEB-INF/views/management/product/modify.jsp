									...
									<div class="d-flex flex-row">
										...
										<div class="d-flex flex-column flex-grow-1">
											...
											<div class="d-flex flex-row align-items-center mt-2">
												...
												<input type="number" class="form-control" id="discount_rate" name="discount_rate" min="0" max="100" placeholder="할인율" value="<%= product.getDiscount_rate()%>"/>
											</div>
											<div class="d-flex flex-row align-items-center mt-2">
        ...
        $("#btn-submit").click(()=>{
        	...
        	$.ajax({
        		...
        		success:(result, status, xhr)=>{
        			...
        			alert('상품이 업데이트되었습니다.');
        			// 성공 후 폼 초기화 또는 리다이렉트
        			location.replace("<%=contextPath%>/admin/product/detail?product_id=<%= product.getProduct_id()%>");
        		},
